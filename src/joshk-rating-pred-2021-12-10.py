...
actual_test_output['prediction'] = actual_test_output['reviewerID'].map(actual_pred_dict)
actual_test_output[['reviewerID-itemID','prediction']].to_csv('jk-rating-output-2021-12-10-v4.csv')


actual_test_output[~actual_test_output['reviewerID'].isin(ratings_sample['reviewerID'])]

actual_test_output[~actual_test_output['itemID'].isin(ratings_sample['itemID'])]